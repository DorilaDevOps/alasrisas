...
import { initForm, setFormOnLogin, setFormAfterRegister } from './components/form.js';
import { initCarousel, stopAutoplay, startAutoplay } from './components/carousel.js';
import { renderComentarios, initProfileEdit, initWalletListeners, setStatsCallbacks, openWallet } from './components/wallet.js';
import { updateStats, renderUsers, initSeedData, initModal } from './components/user.js';

document.addEventListener('DOMContentLoaded', () => {

  setFormOnLogin((user) => { openWallet(user); });
...
function updateFloatingButtons() {
  ...
  toggleFloatingButtons(window.scrollY >= maxScroll * 0.5);
}
